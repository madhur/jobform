      ...
      .factory('RzSlider', ['$timeout', '$document', '$window', 'throttle', function($timeout, $document, $window, throttle)
      {
        ...
        Slider.prototype = {
          ...
          translateFn: function(value, label, useCustomTr)
          {
            ...
            if(label[0].parentNode.attributes[5]!= undefined && label[0].parentNode.attributes[5].value== "expSlider"){
            	if(valStr=="0"){
            		console.log(label[0].parentNode.attributes[3].nodeValue);
            		label.text(label[0].parentNode.attributes[3].nodeValue);
            	}else if(valStr=="11"){
            		label.text(label[0].parentNode.attributes[4].nodeValue);
            	}else{
            		label.text(valStr + label[0].parentNode.attributes[2].nodeValue); 
            	}
            }else if(label[0].parentNode.attributes[5]!= undefined && label[0].parentNode.attributes[5].value== "ctcSlider"){
            	if(valStr=="0"){
            		console.log(label[0].parentNode.attributes[3].nodeValue);
            		label.text(label[0].parentNode.attributes[3].nodeValue);
            	}else if(valStr=="16"){
          ...
          updateCeilLab: function()
          {
            ...
            if(this.ceilLab[0].parentNode.attributes[5]!=undefined && this.ceilLab[0].parentNode.attributes[5].nodeValue=="expSlider"){
            	this.ceilLab[0].innerHTML = "10+" ;
            }
            else if(this.ceilLab[0].parentNode.attributes[5]!=undefined && this.ceilLab[0].parentNode.attributes[5].nodeValue=="ctcSlider"){
            	this.ceilLab[0].innerHTML = "15+" ;
            }
	  },
          ...
          updateFloorLab: function()
          {
            ...
            if(this.flrLab[0].parentNode.attributes[5]!=undefined && this.flrLab[0].parentNode.attributes[5].nodeValue=="expSlider"){
            	this.flrLab[0].innerHTML = "<1" ;
            }
            else if(this.flrLab[0].parentNode.attributes[5]!=undefined && this.flrLab[0].parentNode.attributes[5].nodeValue=="ctcSlider"){
            	this.flrLab[0].innerHTML = "<1" ;
            }
          },
...
// IDE assist
  ...
  module.run(['$templateCache', function($templateCache) {
    ...
    +"<span class=rz-bar-wrapper><span class=\"rz-bar rz-selection\"></span></span> <span class=rz-pointer></span> <span class=rz-pointer></span>"
     +"<span id=\"leftHandle\" class=\"rz-bubble rz-limit\"></span> <span id=\"rightHandle\"  class=\"rz-bubble rz-limit\"></span> <span id=\"bubble-up\" class=rz-bubble></span> <span class=rz-bubble></span> <span class=rz-bubble></span><ul class=rz-ticks></ul>"
  );
